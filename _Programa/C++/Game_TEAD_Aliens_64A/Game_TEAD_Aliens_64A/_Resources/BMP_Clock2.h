...
;|
;| Source
;|     Path : C:\____NEPER\___PROJETOS\_______NP\____Games\_Game_Block\_Programa\C++\Game_TEAD_Aliens_64A\Game_TEAD_Aliens_64A\_Resources\Clock2.bmp
;|     File : Clock2.bmp
;|
;| Image Properties
;|     Size   :     8 Bytes
...
const uint8_t BMP_Clock2[] PROGMEM =
{
	//+------------+
	//| BMP Header |
	//+------------+
	...
	//|  BMP Data  |
	//+------------+
	0x3C,0x46,0x89,0x99,0x99,0x85,0x42,0x3C 	//8
