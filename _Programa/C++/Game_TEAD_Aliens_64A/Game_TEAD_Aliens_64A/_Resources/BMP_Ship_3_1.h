...
;|
;| Source
;|     Path : C:\____NEPER\___PROJETOS\_______NP\____Games\_Game_Block\_Programa\C++\Game_TEAD_Aliens_64A\Game_TEAD_Aliens_64A\_Resources\Ship_3_1.bmp
;|     File : Ship_3_1.bmp
;|
;| Image Properties
;|     Size   :     2 Bytes
...
const uint8_t BMP_Ship_3_1[] PROGMEM =
{
	//+------------+
	//| BMP Header |
	//+------------+
