...
;|
;| Source
;|     Path : C:\____NEPER\___PROJETOS\_______NP\____Games\_Game_Block\_Programa\C++\Game_TEAD_Aliens_64A\Game_TEAD_Aliens_64A\_Resources\Down_big.bmp
;|     File : Down_big.bmp
;|
;| Image Properties
;|     Size   :     5 Bytes
...
const uint8_t BMP_Down_big[] PROGMEM =
{
	//+------------+
	//| BMP Header |
	//+------------+
