...
;|
;| Source
;|     Path : C:\____NEPER\___PROJETOS\_______NP\____Games\_Game_Block\_Programa\C++\Game_TEAD_Aliens_64A\Game_TEAD_Aliens_64A\_Resources\cobra.bmp
;|     File : cobra.bmp
;|
;| Image Properties
;|     Size   :     8 Bytes
...
const uint8_t BMP_cobra[] PROGMEM =
{
	//+------------+
	//| BMP Header |
	//+------------+
	...
	//|  BMP Data  |
	//+------------+
	0xFF,0x81,0xBD,0xA5,0xA5,0xB1,0x81,0xFF 	//8
