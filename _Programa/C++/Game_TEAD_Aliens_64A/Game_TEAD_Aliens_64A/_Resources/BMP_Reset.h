...
;|
;| Source
;|     Path : C:\____NEPER\___PROJETOS\_______NP\____Games\_Game_Block\_Programa\C++\Game_TEAD_Aliens_64A\Game_TEAD_Aliens_64A\_Resources\Reset.bmp
;|     File : Reset.bmp
;|
;| Image Properties
;|     Size   :     8 Bytes
...
const uint8_t BMP_Reset[] PROGMEM =
{
	//+------------+
	//| BMP Header |
	//+------------+
	...
	//|  BMP Data  |
	//+------------+
	0x3C,0x3C,0x3C,0x18,0x00,0x7E,0xC3,0x00 	//8
