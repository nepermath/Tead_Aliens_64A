...
;|
;| Source
;|     Path : C:\____NEPER\___PROJETOS\_______NP\____Games\_Game_Block\_Programa\C++\Game_TEAD_Aliens_64A\Game_TEAD_Aliens_64A\_Resources\Right_Big.bmp
;|     File : Right_Big.bmp
;|
;| Image Properties
;|     Size   :     5 Bytes
...
const uint8_t BMP_Right_Big[] PROGMEM =
{
	//+------------+
	//| BMP Header |
	//+------------+
