...
;|
;| Source
;|     Path : C:\____NEPER\___PROJETOS\_______NP\____Games\_Game_Block\_Programa\C++\Game_TEAD_Aliens_64A\Game_TEAD_Aliens_64A\_Resources\Left_Little.bmp
;|     File : Left_Little.bmp
;|
;| Image Properties
;|     Size   :     5 Bytes
;|     Width  :     5 Pixels
...
const uint8_t BMP_Left_Little[] PROGMEM =
{
	//+------------+
	//| BMP Header |
	//+------------+
