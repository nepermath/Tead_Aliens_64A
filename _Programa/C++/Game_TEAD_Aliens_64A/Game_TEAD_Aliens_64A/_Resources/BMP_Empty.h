...
;|
;| Source
;|     Path : C:\____NEPER\___PROJETOS\_______NP\____Games\_Game_Block\_Programa\C++\Game_TEAD_Aliens_64A\Game_TEAD_Aliens_64A\_Resources\Empty.bmp
;|     File : Empty.bmp
;|
;| Image Properties
;|     Size   :     8 Bytes
...
const uint8_t BMP_Empty[] PROGMEM =
{
	//+------------+
	//| BMP Header |
	//+------------+
	...
	//|  BMP Data  |
	//+------------+
	0x00,0x00,0x24,0x18,0x18,0x24,0x00,0x00 	//8
