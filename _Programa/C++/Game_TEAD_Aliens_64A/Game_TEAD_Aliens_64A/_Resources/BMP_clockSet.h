...
;|
;| Source
;|     Path : C:\____NEPER\___PROJETOS\_______NP\____Games\_Game_Block\_Programa\C++\Game_TEAD_Aliens_64A\Game_TEAD_Aliens_64A\_Resources\clockSet.bmp
;|     File : clockSet.bmp
;|
;| Image Properties
;|     Size   :     8 Bytes
...
const uint8_t BMP_clockSet[] PROGMEM =
{
	//+------------+
	//| BMP Header |
	//+------------+
	...
	//|  BMP Data  |
	//+------------+
	0xB8,0x54,0x92,0xF2,0x82,0x44,0x3A,0x01 	//8
