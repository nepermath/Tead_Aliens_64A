...
;|
;| Source
;|     Path : C:\____NEPER\___PROJETOS\_______NP\____Games\_Game_Block\_Programa\C++\Game_TEAD_Aliens_64A\Game_TEAD_Aliens_64A\_Resources\Up_Big.bmp
;|     File : Up_Big.bmp
;|
;| Image Properties
;|     Size   :     5 Bytes
...
const uint8_t BMP_Up_Big[] PROGMEM =
{
	//+------------+
	//| BMP Header |
	//+------------+
