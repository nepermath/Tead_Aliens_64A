...
;|
;| Source
;|     Path : C:\____NEPER\___PROJETOS\_______NP\____Games\_Game_Block\_Programa\C++\Game_TEAD_Aliens_64A\Game_TEAD_Aliens_64A\_Resources\SHIP_DOT_2_3.bmp
;|     File : SHIP_DOT_2_3.bmp
;|
;| Image Properties
;|     Size   :     2 Bytes
;|     Width  :     2 Pixels
...
const uint8_t BMP_SHIP_DOT_2_3[] PROGMEM =
{
	//+------------+
	//| BMP Header |
	//+------------+
